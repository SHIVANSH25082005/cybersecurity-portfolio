...
The projects focus on incident analysis, security monitoring, phishing investigation, and basic security automation using Python. All projects are designed to reflect real-world SOC (Security Operations Center) analyst tasks.
...
- Basic Python scripting for security automation
